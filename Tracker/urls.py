...
urlpatterns = [
    ...
    url(r'^calendar/(?P<project_id>[0-9]+)/(?P<member_id>[0-9]+)/$',views.calendar, name='calendar'),
    url(r'^calendar1/(?P<project_id>[0-9]+)/(?P<member_id>[0-9]+)/(?P<year>[0-9]+)/(?P<month>[0-9]+)/$',views.calendar1, name='calendar1'),
    url(r'^calendar2/(?P<project_id>[0-9]+)/(?P<member_id>[0-9]+)/(?P<year>[0-9]+)/(?P<month>[0-9]+)/$',views.calendar2, name='calendar2'),
#Task
